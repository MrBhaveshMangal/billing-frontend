...
import ReciptPopup from '../ReciptPopup/ReciptPopup';
...
const CartSummary = ({ customerName, mobileNumber, setMobileNumber, setCustomerName }) => {
  ...
  const completePayment = async (paymentMode) => {
    ...
    try {
      ...
      if (response.status === 201 && paymentMode === "cash") {
      ...
      } else if ((response.status === 201 || response.status === 202) && paymentMode === "upi") {
        ...
        const options = {
          ...
          modal: {
            //agar customer payment complete na kre (mtlb modal ko hi close kr de toh hum voh order hi delete kar denge)
  ...
  const verifyPaymentHandler = async (response, savedOrder) => {
    ...
    try {
      ...
      if (paymentResponse.status === 200) {
        ...
        toast.error("Payment processig failed");
      }
